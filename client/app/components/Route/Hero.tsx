...
const Hero: FC<Props> = (props) => {
  const { data } = useGetHeroSectionDataQuery("Banner");
    ...
    <div className="w-full 1000px:flex items-center">
      ...
      <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
        ...
        <div className=" 1500px:w-[55%]  1100p:w-[78%] w-[90%] h-[50px] bg-transparent relative">
          ...
          />
          <div className="absolute flex items-center justify-center w-[50px] h-[50px] cursor-pointer right-0 top-0 rounded-r-[5px] bg-[#39c1f3]">
