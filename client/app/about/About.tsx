  ...
  return (
    <div className="text-black dark:text-white !mb-20">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text_animation"> Learnbay®️ </span>?
      </h1>
      <br />
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <div className="text-[18px] font-Poppins">
          ...
          <br />
          <br />
          With Learnbay by your side, there&apos;s nothing standing between you and
          ...
          <br />
          <br />
          So what are you waiting for? Join the Learnbay family today and let&apos;s
          ...
          <br />
          <br />
          <span className="text-[22px]">Tazheeb Shamsi -</span>
          <h5 className="text-18px font-Poppins">
            Founder and CEO of Learnbay
          </h5>
        </div>
      </div>
    </div>
